                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?=base_url('barang/add')?>" class="btn btn-icon icon-left btn-success rounded float-right"><i class="fa fa-plus fa-xl"></i>&nbsp Tambah Data</a>
                        </div>
              <div class="card-body">
                  ...
                  foreach($databarang as $row):
                      ?>
                          <tr>
                            ...
                            <td><?= format_rupiah($row['harga_barang'], 'IDR', 'id_ID', 2) ?></td>
                            <td><?=$row['stok']?></td>
                            <td>
                               <a href="<?=base_url('barang/viewData/'.$row['id_barang'])?>" class="btn btn-warning btn-sm">Ubah</a>
